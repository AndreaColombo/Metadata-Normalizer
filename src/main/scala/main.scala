...
object main extends App {
  ...
  for (a <- term_type){
    ...
    val b = parse(query_handler.run_q1("tissue"))
...
//    println(recsys1.length,recsys2.length,recsys3.length,recsys4.length)
...
//  recommender completo per disease e cell line

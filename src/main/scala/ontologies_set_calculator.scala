...
//            score = (weight1_sc + weight2_sc) / terms.length
            if (coverage > 0.50) {
              ...
              if (!boh)
                ...
                println(t, onto + "," + onto2, coverage.toString, score.toString, suitability.toString)
            }
          }
          else {
            val terms12 = terms
...
//            score = (weight1_sc + weight2_sc + weight3_sc) / terms.length
            if (coverage > 0.50) {
              println(t, onto + "," + onto2 + "," + onto3, coverage.toString, score.toString, suitability.toString)

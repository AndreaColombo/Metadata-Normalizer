...
//      val terms1 = ontos(i)._3
      ...
      val weight1_sc = terms1.size * scores._1
...
//        val terms2 = ontos(j)._3
        ...
        val weight2_sc = terms2good.size * scores._1
...
//          val terms3 = ontos(k)._3
          if (terms.equals(terms ++ terms3)) {
            ...
            score = (weight1_sc + weight2_sc) / terms.size
            if (coverage > 0.98) {
